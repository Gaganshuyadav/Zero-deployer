...
const strictEnvs = {
        ...
        PRETRY_CLICKHOUSE_CHUNK_MAX_RETRIES : process.env.PRETRY_CLICKHOUSE_CHUNK_MAX_RETRIES || 3,
        KAFKA_CONSUMER_PAUSE_ON_FAILURE_THRESHOLD: process.env.KAFKA_CONSUMER_PAUSE_ON_FAILURE_THRESHOLD || 3,
        KAFKA_CONSUMER_PAUSE_ON_FAILURE_DURATION_MS: process.env.KAFKA_CONSUMER_PAUSE_ON_FAILURE_DURATION_MS || 30000,
...
const optionalEnv = {
    ...
    IS_REDIS_ENABLED: process.env.IS_REDIS_ENABLED,
};
